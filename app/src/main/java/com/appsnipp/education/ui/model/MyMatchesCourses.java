...
//                new MatchCourse(6, "Detailed Rolling Pin", "$145.00 USD", R.drawable.shop6)
                new MatchCourse(1, "Digital Marketing", "12 Videos", R.drawable.ic_user),
                new MatchCourse(2, "Business", "50 Videos", R.drawable.ic_user),
                new MatchCourse(3, "Development", "265 Videos", R.drawable.ic_user),
                new MatchCourse(4, "Security", "18 Videos", R.drawable.ic_user),
                new MatchCourse(5, "Ethical Hacking", "36 Videos", R.drawable.ic_user),
                new MatchCourse(6, "Mobile", "145 Videos", R.drawable.ic_user)
